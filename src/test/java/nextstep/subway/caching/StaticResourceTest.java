package nextstep.subway.caching;
...
import static nextstep.subway.WebConfigurer.PREFIX_STATIC_RESOURCES;
...
public class StaticResourceTest {
    ...
    void get_static_resources() {
        String uri = PREFIX_STATIC_RESOURCES + "/" + versionHelper.getVersion() + "/js/main.js";
